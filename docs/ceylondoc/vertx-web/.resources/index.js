...
{'name': 'Router.head', 'type': 'function', 'url': 'Router.type.html#head', 'doc': '<p>Add a route that matches any HTTP HEAD request</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'Router.handle', 'type': 'function', 'url': 'Router.type.html#handle', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'RoutingContext.removeCookie', 'type': 'function', 'url': 'RoutingContext.type.html#removeCookie', 'doc': '<p>Remove a cookie from the cookie set. I</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'Session.isEmpty', 'type': 'function', 'url': 'Session.type.html#isEmpty', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'Session.value', 'type': 'function', 'url': 'Session.type.html#value', 'doc': '<p>The short representation of the session to be added to the session cookie.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'Route.blockingHandler', 'type': 'function', 'url': 'Route.type.html#blockingHandler', 'doc': '<p>Specify a blocking request handler for the route.\nT</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'Route.failureHandler', 'type': 'function', 'url': 'Route.type.html#failureHandler', 'doc': '<p>Append a failure handler to the route failure handlers list.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'Route.handler', 'type': 'function', 'url': 'Route.type.html#handler', 'doc': '<p>Append a request handler to the route handlers list.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'BodyHandler.setPreallocateBodyBuffer', 'type': 'function', 'url': 'handler/BodyHandler.type.html#setPreallocateBodyBuffer', 'doc': '<p>Pre-allocate the body buffer according to the value parsed from content-length header.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'StaticHandler.skipCompressionForMediaTypes', 'type': 'function', 'url': 'handler/StaticHandler.type.html#skipCompressionForMediaTypes', 'doc': '<p>Skip compression if the media type of the file to send is in the provided <code>mediaTypes</code> set.\n<code></code></p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'StaticHandler.skipCompressionForSuffixes', 'type': 'function', 'url': 'handler/StaticHandler.type.html#skipCompressionForSuffixes', 'doc': '<p>Skip compression if the suffix of the file to send is in the provided <code>fileSuffixes</code> set.\n<code></code></p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'SockJSSocket.fetch', 'type': 'function', 'url': 'handler/sockjs/SockJSSocket.type.html#fetch', 'doc': '<p>Fetch the specified <code>amount</code> of elements. I</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'SockJSSocket.pause', 'type': 'function', 'url': 'handler/sockjs/SockJSSocket.type.html#pause', 'doc': '<p>Pause the <code>ReadStream</code>. W</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'SockJSSocket.close', 'type': 'function', 'url': 'handler/sockjs/SockJSSocket.type.html#close', 'doc': '<p>Close it giving a status code and reason.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'SockJSSocket.close', 'type': 'function', 'url': 'handler/sockjs/SockJSSocket.type.html#close', 'doc': '<p>Close it</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'SessionStore.init', 'type': 'function', 'url': 'sstore/SessionStore.type.html#init', 'doc': '<p>Initialize this store.</p>', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'sessionStore.create', 'type': 'function', 'url': 'sstore/sessionStore.object.html#create', 'doc': '<p>Create a Session store given a backend and configuration JSON.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'sessionStore.create', 'type': 'function', 'url': 'sstore/sessionStore.object.html#create', 'doc': '<p>Create a Session store given a backend and configuration JSON.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'sessionStore.create', 'type': 'function', 'url': 'sstore/sessionStore.object.html#create', 'doc': '<p>Create a Session store given a backend and configuration JSON.</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'sessionStore', 'type': 'object', 'url': 'sstore/sessionStore.object.html', 'doc': '', 'tags': [],'icons': ['icon-object']},
{'name': 'sessionStore', 'type': 'value', 'url': 'sstore/index.html#sessionStore', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
...
{'name': 'io.vertx.ceylon.web.templ.handlebars', 'type': 'package', 'url': 'templ/handlebars/index.html', 'doc': '', 'tags': [],'icons': ['icon-package']},
{'name': 'handlebarsTemplateEngine.create', 'type': 'function', 'url': 'templ/handlebars/handlebarsTemplateEngine.object.html#create', 'doc': '<p>Create a template engine using defaults</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'handlebarsTemplateEngine', 'type': 'object', 'url': 'templ/handlebars/handlebarsTemplateEngine.object.html', 'doc': '', 'tags': [],'icons': ['icon-object']},
{'name': 'handlebarsTemplateEngine', 'type': 'value', 'url': 'templ/handlebars/index.html#handlebarsTemplateEngine', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'HandlebarsTemplateEngine.setExtension', 'type': 'function', 'url': 'templ/handlebars/HandlebarsTemplateEngine.type.html#setExtension', 'doc': '<p>Set the extension for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'HandlebarsTemplateEngine.setMaxCacheSize', 'type': 'function', 'url': 'templ/handlebars/HandlebarsTemplateEngine.type.html#setMaxCacheSize', 'doc': '<p>Set the max cache size for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'HandlebarsTemplateEngine', 'type': 'class', 'url': 'templ/handlebars/HandlebarsTemplateEngine.type.html', 'doc': '<p>A template engine that uses the Handlebars library.</p>', 'tags': [],'icons': ['icon-class']},
{'name': 'io.vertx.ceylon.web.templ.jade', 'type': 'package', 'url': 'templ/jade/index.html', 'doc': '', 'tags': [],'icons': ['icon-package']},
{'name': 'jadeTemplateEngine.create', 'type': 'function', 'url': 'templ/jade/jadeTemplateEngine.object.html#create', 'doc': '<p>Create a template engine using defaults</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'jadeTemplateEngine', 'type': 'object', 'url': 'templ/jade/jadeTemplateEngine.object.html', 'doc': '', 'tags': [],'icons': ['icon-object']},
{'name': 'jadeTemplateEngine', 'type': 'value', 'url': 'templ/jade/index.html#jadeTemplateEngine', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'JadeTemplateEngine.setExtension', 'type': 'function', 'url': 'templ/jade/JadeTemplateEngine.type.html#setExtension', 'doc': '<p>Set the extension for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'JadeTemplateEngine.setMaxCacheSize', 'type': 'function', 'url': 'templ/jade/JadeTemplateEngine.type.html#setMaxCacheSize', 'doc': '<p>Set the max cache size for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'JadeTemplateEngine', 'type': 'class', 'url': 'templ/jade/JadeTemplateEngine.type.html', 'doc': '<p>A template engine that uses Jade.</p>', 'tags': [],'icons': ['icon-class']},
{'name': 'io.vertx.ceylon.web.templ.mvel', 'type': 'package', 'url': 'templ/mvel/index.html', 'doc': '', 'tags': [],'icons': ['icon-package']},
{'name': 'mvelTemplateEngine.create', 'type': 'function', 'url': 'templ/mvel/mvelTemplateEngine.object.html#create', 'doc': '<p>Create a template engine using defaults</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'mvelTemplateEngine', 'type': 'object', 'url': 'templ/mvel/mvelTemplateEngine.object.html', 'doc': '', 'tags': [],'icons': ['icon-object']},
{'name': 'mvelTemplateEngine', 'type': 'value', 'url': 'templ/mvel/index.html#mvelTemplateEngine', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'MVELTemplateEngine.setExtension', 'type': 'function', 'url': 'templ/mvel/MVELTemplateEngine.type.html#setExtension', 'doc': '<p>Set the extension for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'MVELTemplateEngine.setMaxCacheSize', 'type': 'function', 'url': 'templ/mvel/MVELTemplateEngine.type.html#setMaxCacheSize', 'doc': '<p>Set the max cache size for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'MVELTemplateEngine', 'type': 'class', 'url': 'templ/mvel/MVELTemplateEngine.type.html', 'doc': '<p>A template engine that uses the Handlebars library.</p>', 'tags': [],'icons': ['icon-class']},
{'name': 'io.vertx.ceylon.web.templ.thymeleaf', 'type': 'package', 'url': 'templ/thymeleaf/index.html', 'doc': '', 'tags': [],'icons': ['icon-package']},
{'name': 'thymeleafTemplateEngine.create', 'type': 'function', 'url': 'templ/thymeleaf/thymeleafTemplateEngine.object.html#create', 'doc': '<p>Create a template engine using defaults</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'thymeleafTemplateEngine', 'type': 'object', 'url': 'templ/thymeleaf/thymeleafTemplateEngine.object.html', 'doc': '', 'tags': [],'icons': ['icon-object']},
{'name': 'thymeleafTemplateEngine', 'type': 'value', 'url': 'templ/thymeleaf/index.html#thymeleafTemplateEngine', 'doc': '', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'ThymeleafTemplateEngine.setMode', 'type': 'function', 'url': 'templ/thymeleaf/ThymeleafTemplateEngine.type.html#setMode', 'doc': '<p>Set the mode for the engine</p>', 'tags': [],'icons': ['icon-shared-member']},
{'name': 'ThymeleafTemplateEngine', 'type': 'class', 'url': 'templ/thymeleaf/ThymeleafTemplateEngine.type.html', 'doc': '<p>A template engine that uses the Thymeleaf library.</p>', 'tags': [],'icons': ['icon-class']},
